...
create table IF NOT EXISTS daily_kpts (
    id integer primary key AUTO_INCREMENT,
    created_at datetime,
    updated_at datetime,
    deleted_at datetime,
...
create table IF NOT EXISTS kpt_reaction_histories (
    id integer primary key AUTO_INCREMENT,
    created_at datetime,
    updated_at datetime,
    deleted_at datetime,
...
DROP TABLE IF EXISTS users, daily_kpts, goals, kpt_reaction_histories, todo_lists, genres;
